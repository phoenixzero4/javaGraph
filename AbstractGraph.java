...
public abstract class AbstractGraph<V> implements Graph<V> {
	...
	// create graph from vertices and edges stored in arrays
	...
	// Construct graph from vertices and edges stored in a list
	...
	// construct graph from int vertices and edge list
	...
	// construct graph from integer vertices and edge array
	...
	public static class Edge {
		public int u; // starting vertex
		public int v; // ending vertex
